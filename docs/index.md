...
!!! info
    ...
    **Source Code Repository:** [https://github.com/mvaldron-rhdh/audio-test-app-2](https://github.com/mvaldron-rhdh/audio-test-app-2)

    **GitOps Repository:** [https://github.com/mvaldron-rhdh/audio-test-app-2-gitops](https://github.com/mvaldron-rhdh/audio-test-app-2-gitops)

# **Usage**

To access the audio-test-app-2 application that was deployed using the Software Template, complete the following instructions:
